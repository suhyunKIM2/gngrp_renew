...
// 	orgaTree.setInfoImg("../common/images/tree/noitem.gif");
    ...
    g_strNoItemText = "<spring:message code='dms.sub.exits' text='하위분류가 존재하지 않습니다.'/>";
	...
	function OnOK(node) {
		...
		if(nekDatas != null && nekDatas != "")
		{
			...
			if(WINDOW_MODALDIALOG == "${iOpenMode}"){
				...
				var listURL = "./categoryListPerson.htm?pCategoryId=" + nek_datas[1];
	...
	$(function(){ 
	    ...
	    $("#treeCtnr").dynatree({
	    	...
	    	onLazyRead: function(node) {		// 처음으로 확장 될 때 호출됩니다.
				node.appendAjax({
					url: "/dms/categoryCallerPerson.htm",
