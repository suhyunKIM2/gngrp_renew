...
//				console.log($("#"+iRow+"_"+nmjq,$t.rows[iRow]).is(":checked"));
//				console.log($("#"+iRow+"_"+nmjq,$t.rows[iRow]).attr("checked")?true:false);
//				console.log($t.p.savedRow[fr]);
//				console.log(v2 !== $t.p.savedRow[fr].v);
