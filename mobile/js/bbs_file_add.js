...
var makeUploadElem = function(fileElemObj){
	...
	var fileElem=$("<input id='file"+fileIndex+"' class='file' type='file' value='' data-mini='true' name='bbs.mobileFiles["+fileIndex+"]' style='width:94px;position: absolute;right:0px;top:0px; opacity:0; filter: alpha(opacity=0);cursor: pointer;outline:none;'/>");
