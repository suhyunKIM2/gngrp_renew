...
<div class="layer_wrap" layer="1">sss<a href="javascript:;" class="btn_close">저장</a></div>
   ...
   <% if (isPartnerTemp) {%>
    ...
    <div class="user_info_div">
        ...
        <ul class="user_info_right">
            ...
            <li class="inline_block_li nth-child_02 btn_layer" onClick="javascript:;" layer="2">근무중</li>
            <li class="inline_block_li nth-child_03 btn_layer" onClick="javascript:;" layer="3">퇴근</li>
        ...
        <div class="work_info_div">
            <ul>
                <li><b>출근</b> <span>09:00</span></li>
                <li><b>퇴근</b> <span>-</span></li>
            </ul>
        </div>
    </div>
</div>
