...
<div class="sidebar_menu">
    <div class="home_icon_div">
     ...
     <div class="menu_wrap">
         <div data-role="page" class="type-home" id="page-home" style="position:relative;clear: both;z-index: 1;background: #fff;z-index: 99;"><jsp:include page="/mobile/top_dev.jsp"></jsp:include></div>
     </div>
</div>
